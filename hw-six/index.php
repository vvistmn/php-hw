...
class Chocolate extends Product 
{
	...
	public function ShowImage()
	{
		echo "<div style='background: url({$this-> bg}) no-repeat center center; background-size: 100%; height:200px; width:200px;'></div>";
	}
}
...
class Candy extends Product
{
	...
	{
		echo "<div style='background: url({$this-> bgI}) no-repeat center center; background-size: 100%; height:100px; width:100px;'></div>";
	}
}
