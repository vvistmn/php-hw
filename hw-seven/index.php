...
$aboutCareerData = $connection->query("SELECT * FROM aboutCareer");
$aboutCareerData = $aboutCareerData->fetch();
$career = $connection->query("SELECT * FROM career");
$projects = $connection->query("SELECT * FROM projects");
$skillset = $connection->query("SELECT * FROM skillset");
        ...
        <div class="main-wrapper">
            ...
            <?
                ...
                if($_POST['comment']) {
                    ...
                    echo "Здесь пока нет никаких комментариев :(" . "</div>";
                }
